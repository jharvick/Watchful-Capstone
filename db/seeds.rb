...
# Item.create(name: "Anchorman: The Legend of Ron Burgandy", image_url: "https://thumbs.gfycat.com/FrighteningEmbellishedFeline-max-1mb.gif", description: "The funniest movie of all time.", category: "Movie")
# Item.create(name: "How to be Single", image_url: "https://thumbs.gfycat.com/FrighteningEmbellishedFeline-max-1mb.gif", description: "The funniest movie of all time.", category: "Movie")
